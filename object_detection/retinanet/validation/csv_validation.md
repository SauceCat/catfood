...
def _get_detections(
    ...
    # all_detections = [[None * num_classes] * dataset length]
    all_detections = [
        [None for i in range(dataset.num_classes())] 
...
def _get_annotations(generator):
    ...
    """
    all_annotations = [
        [None for i in range(generator.num_classes())] 
    ...
    for label in range(generator.num_classes()):
        ...
        for i in range(len(generator)):
            ...
            for d in detections:
                ...
                # iou between current detection and annotations
